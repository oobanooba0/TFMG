--Here i attempt to intercept the default collsion masks and replace them with my own. Lets see.


local building = function() return {layers={item=true, meltable=true, object=true, player=true, water_tile=true, is_object=true, is_lower_object=true, unstable=true,}} end
local building_unheated = function() return {layers={item=true, object=true, player=true, water_tile=true, is_object=true, is_lower_object=true,unstable=true,}} end
