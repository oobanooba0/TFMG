...
--Due to the removal of vanilla techs, shortcuts dependant on them must be modified.
	...
	data.raw ["shortcut"]["toggle-tall-entity-visibility"].unavailable_until_unlocked = nil
