...
local technology_name = "fluid-extraction"
...
local function create_fill_barrel_recipe(item, fluid)
  ...
  local recipe =
  {
    ...
    ingredients =
    {
      {type = "fluid", name = fluid.name, amount =  fluid_density, ignored_by_stats = fluid_density},
...
---manual barrel recipe adjustments

ETFB = data.raw.recipe["empty-thruster-fuel-barrel"]
...
ETOB = data.raw.recipe["empty-thruster-oxidizer-barrel"]
