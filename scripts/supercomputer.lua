...
function supercomputer.on_supercomputer_built(entity)
  ...
  if direction == 8 then
    inputxy = {position_x-2,position_y-2}
    outputxy = {position_x+2,position_y-2}
  ...
  local supercomputer_input = surface.create_entity({ name = "supercomputer-input", position = inputxy, force = force, direction = direction })
  local supercomputer_output = surface.create_entity({ name = "supercomputer-output", position = outputxy, force = force, direction = direction})
...
function supercomputer.create_new_problem_introspection(v)
  ...
  v.problem_a = math.random(10)
  v.problem_b = math.random(10)
